...
Light_Left:
    ...
    LSL r16         ; shifting one position to the left
    RCALL Delay     
    CP r16, r17     ; comparing with 0b10000000
    BRNE Light_Left ; if not equal repeat again
    LDI r17, 0x01   ; if equal, shift 0b10000000 to 0b00000001
    RET
  
Light_Right:
    OUT PORTC, r16   ; MSB lighting
    LSR r16          ; shifting one position to the right
    RCALL Delay
    CP r16, r17      ; comparing with 0b00000001
    BRNE Light_Right ; if not equal repeat again
    LDI r17, 0x80    ; if equal, shift 0b00000001 to 0b10000000
    RET
